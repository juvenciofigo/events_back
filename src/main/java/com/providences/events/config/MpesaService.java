...
public class MpesaService {
    ...
    public APIResponse executePayment(String transactionRef, String thirdPartyRef, String customerNum) {
        System.out.println("transaction" + transactionRef);
        System.out.println("thirdPart" + thirdPartyRef);
        System.out.println("numero" + customerNum);
        try {
            ...
            context.addParameter("input_CustomerMSISDN", customerNum);
